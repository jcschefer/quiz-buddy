...
from .idempotents import get_or_create_tournament, get_or_create_packet, get_or_create_tossup

# 1. insert the tournament
tournament = get_or_create_tournament(Tournament(name='PACE NSC', year=2018))

# 2. Packet for round one
round_1 = get_or_create_packet(Packet(tournament=tournament, name='Round 01', round_number=1))
...
r1_q1 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q1_t1,
...
r1_q2 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q2_t1,
...
r1_q3 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q3_t1,
...
r1_q4_answer = 'dolls'
r1_q4 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q4_t1,
...
r1_q5 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q5_t1,
...
r1_q6 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q6_t1,
...
r1_q7 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q7_t1,
...
r1_q8 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q8_t1,
...
r1_q9 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q9_t1,
...
r1_q10 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q10_t1,
...
r1_q11_answer = 'time'
r1_q11 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q11_t1,
...
r1_q12 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q12_t1,
...
r1_q13_answer = 'iron'
r1_q13 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q13_t1,
...
r1_q14 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q14_t1,
...
r1_q15_answer = 'Nepal'
r1_q15 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q15_t1,
...
r1_q16 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q16_t1,
...
r1_q17 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q17_t1,
...
r1_q18 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q18_t1,
...
r1_q19 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q19_t1,
...
r1_q20 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q20_t1,
...
r1_q21 = get_or_create_tossup(Tossup(packet=round_1, text_part_1=r1_q21_t1,
                                         text_part_2=r1_q21_t2, text_part_3=r1_q21_t3, answer=r1_q21_answer, number=21))


# 3. Packet for round two
round_2 = get_or_create_packet(Packet(tournament=tournament, name='Round 02', round_number=2))
...
r2_q01 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q01_t1,
...
r2_q02 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q02_t1,
...
r2_q03 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q03_t1,
...
r2_q04 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q04_t1,
...
r2_q05 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q05_t1,
...
r2_q06 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q06_t1,
...
r2_q07_answer = '1980s'
r2_q07 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q07_t1,
...
r2_q08 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q08_t1,
...
r2_q09 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q09_t1,
...
r2_q10 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q10_t1,
...
r2_q11 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q11_t1,
...
r2_q12 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q12_t1,
...
r2_q13 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q13_t1,
...
r2_q14 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q14_t1,
...
r2_q15 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q15_t1,
...
r2_q16_answer = 'Egypt'
r2_q16 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q16_t1,
...
r2_q17 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q17_t1,
...
r2_q18 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q18_t1,
...
r2_q19 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q19_t1,
...
r2_q20 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q20_t1,
...
r2_q21 = get_or_create_tossup(Tossup(packet=round_2, text_part_1=r2_q21_t1,
                                         text_part_2=r2_q21_t2, text_part_3=r2_q21_t3, answer=r2_q21_answer, number=21))

# 4. Packet for round three
round_3 = get_or_create_packet(Packet(tournament=tournament, name='Round 03', round_number=3))
...
r3_q01 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q01_t1, text_part_2=r3_q01_t2, text_part_3=r3_q01_t3, answer=r3_q01_answer, number=1))
...
r3_q02 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q02_t1, text_part_2=r3_q02_t2, text_part_3=r3_q02_t3, answer=r3_q02_answer, number=2))
...
r3_q03 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q03_t1, text_part_2=r3_q03_t2, text_part_3=r3_q03_t3, answer=r3_q03_answer, number=3))
...
r3_q04 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q04_t1, text_part_2=r3_q04_t2, text_part_3=r3_q04_t3, answer=r3_q04_answer, number=4))
...
r3_q05 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q05_t1, text_part_2=r3_q05_t2, text_part_3=r3_q05_t3, answer=r3_q05_answer, number=5))
...
r3_q06 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q06_t1, text_part_2=r3_q06_t2, text_part_3=r3_q06_t3, answer=r3_q06_answer, number=6))
...
r3_q07 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q07_t1, text_part_2=r3_q07_t2, text_part_3=r3_q07_t3, answer=r3_q07_answer, number=7))
...
r3_q08 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q08_t1, text_part_2=r3_q08_t2, text_part_3=r3_q08_t3, answer=r3_q08_answer, number=8))
...
r3_q09 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q09_t1, text_part_2=r3_q09_t2, text_part_3=r3_q09_t3, answer=r3_q09_answer, number=9))
...
r3_q10 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q10_t1, text_part_2=r3_q10_t2, text_part_3=r3_q10_t3, answer=r3_q10_answer, number=10))
...
r3_q11 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q11_t1, text_part_2=r3_q11_t2, text_part_3=r3_q11_t3, answer=r3_q11_answer, number=11))
...
r3_q12 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q12_t1, text_part_2=r3_q12_t2, text_part_3=r3_q12_t3, answer=r3_q12_answer, number=12))
...
r3_q13 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q13_t1, text_part_2=r3_q13_t2, text_part_3=r3_q13_t3, answer=r3_q13_answer, number=13))
...
r3_q14 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q14_t1, text_part_2=r3_q14_t2, text_part_3=r3_q14_t3, answer=r3_q14_answer, number=14))
...
r3_q15_answer = 'Spain'
r3_q15 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q15_t1, text_part_2=r3_q15_t2, text_part_3=r3_q15_t3, answer=r3_q15_answer, number=15))
...
r3_q16 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q16_t1, text_part_2=r3_q16_t2, text_part_3=r3_q16_t3, answer=r3_q16_answer, number=16))
...
r3_q17 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q17_t1, text_part_2=r3_q17_t2, text_part_3=r3_q17_t3, answer=r3_q17_answer, number=17))
...
r3_q18 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q18_t1, text_part_2=r3_q18_t2, text_part_3=r3_q18_t3, answer=r3_q18_answer, number=18))
...
r3_q19 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q19_t1, text_part_2=r3_q19_t2, text_part_3=r3_q19_t3, answer=r3_q19_answer, number=19))
...
r3_q20 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q20_t1, text_part_2=r3_q20_t2, text_part_3=r3_q20_t3, answer=r3_q20_answer, number=20))
...
r3_q21 = get_or_create_tossup(Tossup(packet=round_3, text_part_1=r3_q21_t1, text_part_2=r3_q21_t2, text_part_3=r3_q21_t3, answer=r3_q21_answer, number=21))
